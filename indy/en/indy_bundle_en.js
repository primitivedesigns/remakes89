const bundle = {
    ...
    item_diamonds_failState: "You won't be able to finish the game without the diamonds. LOAD a savegame or RESTART to try again.",
    ...
    location_m9_bomb_failState: "The explosion destroyed an object that you needed to finish the game. LOAD a savegame or type in RESTART to try again.",
    ...
    intro_text1: "You are Indiana Jones and your goal is to get to your homeland, America. You find yourself in Wenceslas Square under the statue of St. Wenceslas. The date is January 16, 1989.",
