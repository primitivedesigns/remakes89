const bundle = {
    ...
    item_shield_desc: "Modified to shield you from falling rocks.",
    ...
    item_stone_onUse: "O.K. You threw the stone to the right. You heard a scream from the right (which is intriguing).",

    item_tail_name: "tail",
    item_tail_desc: "It's the tail of St. Wenceslas' horse.",
    item_tail_onExamine: " You found an axe in a little crevice below the tail.",

    item_axe_name: "axe",
    item_axe_desc: "This would cut into a cop's stupid head as if it was made out of butter.",
    ...
    item_dictionary_onUse: "O.K. You've translated the writing on the wall. It says that General Secretary Jakeš is a dumbass. It's signed KAREL.",
    ...
    item_rod_name: "rod",
    item_rod_desc: "This could come in handy.",
    ...
    item_uniform_desc: "It's the uniform of the Public Security, or the Czechoslovak police.",
    ...
    item_idcard_desc: "It belongs to a member of the secret police who looks very much like you.",

    item_militiaman_corpse_name: "dead militiaman",
    item_militiaman_corpse_desc: "Someone has thrown an iron rod at him. I've deduced that from the fact that it's sticking out of his head.",
    ...
    location_m1_desc: "O.K. You're standing in front of the Grocery Store building. The subway entrance is fortunately clear. An unpleasant-looking man (probably a Communist) is looking from a balcony, watching in amusement the good work of the Public Security.",
    ...
    location_m9_desc: "O.K. You are standing under the scaffolding. There are roadblocks further down. You can hear a quiet, yet suspicious ticking. You can see the blocked entrance into the Ve Smečkách street.",
    location_m9_desc_exploded: "O.K. You're balancing on the edge of a huge crater. At the bottom, you can see a sign saying 'The House of Fashion'.",
    location_m9_hint: "Can you hear the ticking? Pick up what you can and scram!",
    location_m9_kill: "But you couldn't keep balance and you're falling down.",
    location_m9_bomb_kill: "You noticed a flash followed by a massive explosion. Right before a shard hit you, you realized what the ticking was.",
    ...
    location_m11_kill: "A member of Public Security tackled you and dragged you into an armed truck. Sitting here are some fine young men with iron rods in their hands. They start to play with you.",
    ...
    location_m15_kill: "A civilian charged at you thinking that you are with Public Security. That's because you're still wearing the uniform.",

    location_m16_desc: "O.K. You are lying on the ground in front of the COMRADERIE department store. That's because an officer has just hit you. The subway entrace is blocked. There are tram tracks further down behind some roadblocks.",
